...
•	Leveraged AWS Glue to consolidate the 365 files from Lambda, and re-partition the dataset from daily key to a geographical point ID key, generating 100 time-series datasets, for each point, having a total size of **ONLY 23.8MB** - a big reduction from the original ~100GB
